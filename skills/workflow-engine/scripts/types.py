...
class LLMStep(BlockBase):
    """Single SDK query() call — the atomic LLM unit of work."""
...
class GroupBlock(BlockBase):
    ...
    blocks: list["Block"] = []
    llm_session_policy: Literal["none", "step_segments"] = "step_segments"
...
class ParallelEachBlock(BlockBase):
    ...
    merge_policy: Literal["results_only", "namespaced_variables"] = "results_only"
