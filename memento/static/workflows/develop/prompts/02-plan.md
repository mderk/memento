...
2. Each task should have:
   ...
   - 2-5 **acceptance_criteria** — concrete, verifiable statements about what the implementation must do. Focus on observable behavior, not implementation details. These criteria will be checked by an independent evaluator after implementation.
