...
1. Read Memory Bank context:
   ...
   - `.memory_bank/patterns/index.md`, `.memory_bank/guides/index.md` (optional, for technical context)
2. Follow the workflow at `.agents/skills/create-spec/workflow.md`
