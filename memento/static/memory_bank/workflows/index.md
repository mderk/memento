...
- `/develop` — TDD development workflow (classify → explore → plan → implement → review)
...
- `/process-protocol` — Execute protocol steps in git worktrees with quality checks
